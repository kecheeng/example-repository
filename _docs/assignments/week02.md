...
<span style="color:yellow">In this regard, I borrowed some of Ivan's ppt pictures for elaboration.</span>  Even so, I spent another 3 weeks digesting and understanding the logical steps.  
...
Then, I went to the downloaded student template file, cut and pasted all the files to my Github local repository.  
...
Now, type **git remote** and **git push**, which allow me to push the webpage to remote repository.  
...
If I examine the **mkdocs.yml** file, I can see that **docs_dir** represents **\_docs folder**, whereas **site_dir** for **docs folder**.  
