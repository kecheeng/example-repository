...
In this regard, I hope to design a wooden bag used in winter Finland. After living here for more than one year, no one would denounce that it is dark from November to January, regardless of the astounding polar lights shining occassionally. I noticed that people are advised to hang glittering items to their rucksacks to avoid being bumped away by innocent cyclists or car drivers. I find the reflective patches are a bit insufficient as they totally rely on the given lights or attention from the coming persons. To deal with it, I hope to make the bag shine by itself.  
